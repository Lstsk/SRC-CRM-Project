"""
Django settings for crm project project.
...
ALLOWED_HOSTS = ["src-crm.herokuapp.com/", "127.0.0.1"]
...
WSGI_APPLICATION = 'crm project.wsgi.application'
